...
The cellular graphs are generated from a grid graph shown in /ref.

\begin{figure}[!h]
\centering
\includegraphics[scale=0.4]{cellGeneration.png}
\caption{Example of generation of a cellular graph.}
\end{figure}
...
We have compared our results with the IPL algorithm and we have the same.
