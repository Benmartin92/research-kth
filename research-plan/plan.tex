...
\section{Tools}
For our implementation we will use the JGraphT Library \cite{JGraphT}. It will provides us the essentials structure of graphs and help us generate our cellular graph.
displaying our graph will be done through a Java Applet.
